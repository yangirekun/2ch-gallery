...
export const getAppNetworkStatus = (state: Store) => state.boards.loading || state.images.loading;

export const getAppError = (state: Store) => state.boards.error || state.images.error;
